...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800"
    ...
    >
      ...
      <div className="absolute inset-0 z-15">
        <motion.div
          className="absolute top-1/4 right-1/4 w-32 h-32 bg-secondary-400/10 rounded-full blur-2xl"
          animate={{
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.5, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/3 left-1/4 w-24 h-24 bg-accent-400/10 rounded-full blur-2xl"
          animate={{
            scale: [1.1, 1, 1.1],
            opacity: [0.5, 0.3, 0.5],
          }}
      ...
      >
        ...
        >
          <Link
            to="/join"
            className="group bg-secondary-400 hover:bg-secondary-500 text-black font-tajawal font-bold px-8 py-4 rounded-xl shadow-lg transition-all duration-300 flex items-center gap-3 hover:scale-105"
          >
            {t('hero.button')}
            <ArrowLeft
          ...
          <button className="group flex items-center gap-3 px-6 py-4 border-2 border-white/30 text-white font-tajawal font-semibold rounded-xl hover:border-white/50 hover:bg-white/10 transition-all duration-300">
